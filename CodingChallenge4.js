/* Ternary operator and expression example
Coding Challenge #4
...
*/
const billVal = 430;
const tip = (billVal >= 50 && billVal <= 300) ? (15 / 100) * billVal : (20 / 100) * billVal;
console.log(`The bill was ${billVal}, the tip was ${tip}, and the total value ${billVal + tip}`)
